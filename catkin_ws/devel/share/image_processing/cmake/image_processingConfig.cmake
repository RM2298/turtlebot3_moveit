...
if("TRUE" STREQUAL "TRUE")
  set(image_processing_SOURCE_PREFIX /root/ws/catkin_ws/src/image_processing)
  set(image_processing_DEVEL_PREFIX /root/ws/catkin_ws/devel)
  ...
  set(image_processing_INSTALL_PREFIX /root/ws/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'image_processing' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/ws/catkin_ws/src/image_processing/${idir}'.  ${_report}")
    endif()
